...
export const startGame = () => {
  ...
  gameDiv.innerHTML += `<p id="tries" class="mt-2 uppercase">tries left: <span id="tries-left" class="font-medium text-rose-700">10</span> </p>`;
  ...
  gameDiv.insertAdjacentHTML(
    "beforeend",
    '<button id="quit" class="button-secondary px-2 py-1">Quit</button>'
  );
